...
export class Database extends BaseAPI {
    /**
     ...
     */
    browse(folder: string, levels: number|undefined = undefined, prefix: string|undefined = undefined): Promise<{}> {
    ...
    async completion(device: string, folder: string): Promise<number> {
        const response = await this.get<{completion: number}>('completion', undefined, undefined, { folder: folder, device: device })
     ...
     * @param patterns
     */
    setIgnores(folder: string, patterns: string[]|undefined = undefined): Promise<{}> {
     ...
     * @param folder
     */
    localchanged(folder: string): Promise<{}> {
     ...
     * @param perpage
     */
    need(folder: string, page: number|undefined = undefined, perpage: number|undefined = undefined): Promise<{}> {
     ...
     * @param device
     */
    remoteneed(folder: string, device: string): Promise<{}> {
     ...
     * @param delay
     */
    async scan(folder: string, sub: string|undefined = undefined, delay: number|undefined = undefined): Promise<string> {
        if (sub === undefined) {
            sub = '';
        }
     ...
     * @param folder
     */
    status(folder: string): Promise<any> {
